...
export default function Collection() {
    ...
    useEffect(() => {
        const loadCollection = async () => {
            ...
            setBgVideo(collBlob ? URL.createObjectURL(collBlob) : savedColl || "");
                    ...
                    {collectionItems.map((item, i) => (
                        ...
                        >
                            <img
                                ...
                                onError={(e) => {
                                    (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1595476108010-b4d1f102b1b1?auto=format&fit=crop&q=80&w=800";
                                }}
                            />
                            <div className="absolute inset-0 bg-white/95 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col items-center justify-center p-6 text-center">
                                ...
                                <p className="mt-4 text-[11px] text-luxury-gray font-light leading-relaxed max-w-[200px] transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 delay-100 line-clamp-3 italic">
                                    {item.description}
                                </p>
                                <div className="mt-6 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 delay-150">
